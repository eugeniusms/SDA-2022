...
public class Submitted11 {
    ...
    // Query P, L, C
    public static TreeSet<Koki> kokiS = new TreeSet<Koki>(); // kokiS (terurut minimal melayani)
    public static TreeSet<Koki> kokiG = new TreeSet<Koki>(); // kokiG (terurut minimal melayani)
    public static TreeSet<Koki> kokiA = new TreeSet<Koki>(); // kokiA (terurut minimal melayani)
